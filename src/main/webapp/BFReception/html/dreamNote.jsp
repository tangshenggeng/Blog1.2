...
<head>
<meta charset="UTF-8">
<link rel="shortcut icon" href="${APP_PATH}/myico/myico2.ico" type="image/x-icon" />
<meta name="viewport"
...
<body>
	<div class="header">
		...
		<div class="nav">
			<a href="${APP_PATH }/toHome">HOME</a> <a
				...
				href="${APP_PATH }/toDreamNote" class="active">虚妄之言</a> <a
	...
	<script src="${APP_PATH}/BFReception/res/js/contr/dre_contr.js"></script>
	<script type="text/javascript"
